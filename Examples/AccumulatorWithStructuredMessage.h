...
#ifndef __ACCUMULATOR_WITH_STRUCTURED_MESSAGE_H__
#define __ACCUMULATOR_WITH_STRUCTURED_MESSAGE_H__
 ...
 */
class AccumulatorWithStructuredMessage : public ConnectorListener
{
public:
	/* @brief constructor */
	AccumulatorWithStructuredMessage();

	/* @brief destructor */
	virtual ~AccumulatorWithStructuredMessage();
...
extern int DoAccumulatorWithStructuredMessageTest(int argc, char*argv[] );
