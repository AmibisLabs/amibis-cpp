...
#ifndef __OMISCID_PARSER_H__
#define __OMISCID_PARSER_H__
...
class OMiSCIDMessage
{
 public:
   ...
   */
  OMiSCIDMessage(const OMiSCIDMessage& msg);

  /** @brief Constructor from a message
   *
   */
  OMiSCIDMessage(const Message& MesgFromPeer);
 ...
 * @author Sebastien Pesnel
 */
class OMiSCIDParser : public Thread, public MsgSocketCallbackObject
{
 public:
  /** @brief Constructor */
  OMiSCIDParser();
   ...
   */
  void PushMessage(OMiSCIDMessage* msg);
   ...
   */
  virtual void ProcessAMessage(OMiSCIDMessage* msg);
 ...
 private:
  ...
  MutexedSimpleList<OMiSCIDMessage*> listOMiSCIDMsg; /*!< list of the waiting message*/
  Event NotifyEvent; /*!< Condition used by the method WaitMessage */
